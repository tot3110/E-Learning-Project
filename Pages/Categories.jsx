...
const Categories = () => {
  return (
    <div>
      <h2 className='font-bold text-3xl pl-10 text-center'>Categories</h2>
      
      <div className='flex items-center justify-center pt-10 gap-15'>
        <button className='rounded-full bg-[#6E415E] py-4 px-13 text-xl'>Design</button>
        <img src={Vector5} className='rounded-3xl bg-white py-2 px-2'/>
